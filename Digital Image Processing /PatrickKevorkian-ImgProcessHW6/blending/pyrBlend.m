close all
clear
imga = im2double(imread('/Users/PatrickKevorkian/Desktop/me.jpg'));
imgb = im2double(imread('/Users/PatrickKevorkian/Desktop/lisa2.jpg')); % size(imga) = size(imgb)
...
%my masks
maska = im2double(imread('/Users/PatrickKevorkian/Desktop/faceMaska.png'));
maska = imresize(maska,[size(imgb,1) size(imgb,2)]);

%normal feathering masks, b is dependant on a 
